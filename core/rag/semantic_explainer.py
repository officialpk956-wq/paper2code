...
class SemanticExplainer:
    ...
    def explain(
        ...
        return (
            depth_desc
            + f" A **{node_type_clean}** component optimized for {role_clean}. It processes the incoming tensor to modify its dimensions or extract relevant patterns for downstream use."
        )
