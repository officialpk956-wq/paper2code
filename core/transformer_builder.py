...
class TransformerBuilder:
    ...
    def add_normalization(self, norm_type: str = "layernorm", dim: int | None = None):
    ...
    def add_self_attention(
        self, num_heads: int, embed_dim: int | None = None, causal: bool = False
    ):
    ...
    def add_feedforward(self, hidden_dim: int, embed_dim: int | None = None):
    ...
    def add_classifier_head(self, num_classes: int, in_features: int | None = None):
    ...
    def add_encoder_block(
        self, embed_dim: int, num_heads: int, ffn_dim: int, pre_norm: bool = True
    ):
    ...
    def add_decoder_block(
        self, embed_dim: int, num_heads: int, ffn_dim: int, cross_attention: bool = False
    ):
