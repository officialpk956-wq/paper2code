...
from core.schema_rules_transformer import infer_transformer_block
...
def refine_transformer_schema(raw_schema: dict) -> dict:
    ...
    block_params = infer_transformer_block(schema["block"]["params"])

    refined_stages = []

    for stage in schema["stages"]:
        refined_stages.append({"num_blocks": stage["repeats"], "block": block_params})
