...
ParsingSource = ConfigDict | PaperExcerpt | SymbolicDesc | dict[str, Any]
...
class ComparisonContext(TypedDict, total=False):
    ...
    dominant_compute: Literal["A", "B"] | None
    dominant_spatial: Literal["A", "B"] | None
    scaling_issue: Literal["A", "B"] | None
...
class VisualMetadata(TypedDict, total=False):
    ...
    bottleneck_a: str | None
    bottleneck_b: str | None
