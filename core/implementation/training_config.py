...
TRAINING_CONFIGS: Dict[str, Dict[str, Any]] = {
    ...
    "Transformer": {
        ...
        "warmup": {"steps": 4000, "note": "Critical for Transformer stability. Without warmup, training often diverges."},
        "label_smoothing": 0.1,
    ...
    "ViT": {
        ...
        "warmup": {"steps": 10000, "note": "Essential. ViT trained from scratch is data-hungry and unstable without warmup."},
        "label_smoothing": 0.1,
