...
export default function DomainPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0A] text-white">
      {/* Top Nav */}
      <div className="border-b border-[#262626] px-8 py-6 bg-[#0D0D0D]">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {topics.map(t => (
                  <Link
                    ...
                    className="bg-[#111] border border-[#262626] p-6 rounded-xl block hover:border-[#60A5FA]/50 transition-colors group flex flex-col h-full"
                  >
