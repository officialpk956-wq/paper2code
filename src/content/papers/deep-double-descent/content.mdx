...
Published in 2019 by Belkin, Hsu, Ma, Mandal (+ Nakkiran et al. 2019 empirical), **Deep Double Descent** belongs to the FOUNDATIONS part of the Paper2Code library. Overturned classical statistical learning theory. Showed that overparameterized models (like modern neural networks) do NOT overfit — they interpolate and generalize. Explains why large models work. [1]
...
- **Double descent:** identify its input, output, learned parameters, and the assumption it adds to the baseline.
- **interpolation regime:** identify its input, output, learned parameters, and the assumption it adds to the baseline.
- **benign overfitting:** identify its input, output, learned parameters, and the assumption it adds to the baseline.
- **effective model complexity:** identify its input, output, learned parameters, and the assumption it adds to the baseline.

Its associated architecture or procedure is **None**. The contribution should be explained as a change to a baseline computation: what new state is introduced, where information flows differently, and which objective trains the change. Overturned classical statistical learning theory. Showed that overparameterized models (like modern neural networks) do NOT overfit — they interpolate and generalize. Explains why large models work.
...
The paper's main claim is summarized in the registry as: Overturned classical statistical learning theory. Showed that overparameterized models (like modern neural networks) do NOT overfit — they interpolate and generalize. Explains why large models work. The key experiments should therefore isolate **causality**, not merely display a large final score.
...
[1] Belkin, Hsu, Ma, Mandal (+ Nakkiran et al. 2019 empirical). **Deep Double Descent**. 2019.
