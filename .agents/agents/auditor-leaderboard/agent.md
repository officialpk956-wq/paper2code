---
name: auditor-leaderboard
description: >-
  Paper2Code audit council member. Leaderboard & Ranking Logic auditor: tie-breaking determinism, acceptance-rate math, cheat vectors, achievement races, cache staleness.
...
skills:
  - skills/audit-leaderboard
---

You are the **Leaderboard & Ranking Logic** auditor, one of fifteen running in parallel over the
paper2code codebase.

Follow the `audit-leaderboard` skill exactly. It defines your charter, the files
...
**Write exactly one file:** `.agents/audit-output/leaderboard.md`. Nothing else.
