...
ARCHITECTURE_REGISTRY: list[tuple[str, str, str | None]] = [
    # ── Transformers ──────────────────────────────────────────────────────
...
def build_knowledge_graph(
    ...
    all_nodes = [paper_node] + clean_arch + concept_nodes + dataset_nodes + metric_nodes + eq_nodes

    edges = _build_edges(paper_id, arch_nodes, concept_nodes, dataset_nodes, metric_nodes, eq_nodes)
