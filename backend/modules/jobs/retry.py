...
def calculate_backoff_delay(retry_count: int, base_delay: float = 2.0, max_delay: float = 60.0) -> float:
...
def handle_job_failure(db: Session, job: BackgroundJob, error_message: str, queue_backend, queue_name: str) -> None:
