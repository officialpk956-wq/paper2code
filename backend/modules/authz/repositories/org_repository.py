...
class OrgRepository:
    ...
    def create_org(self, name: str, slug: str, owner_id: int, subscription_tier: str = "Free") -> Organization:
        org = Organization(name=name, slug=slug, owner_id=owner_id, subscription_tier=subscription_tier)
        self.db.add(org)
        self.db.flush()
        return org
    ...
    def get_member(self, organization_id: int, user_id: int) -> Optional[OrganizationMember]:
        return self.db.query(OrganizationMember).filter_by(organization_id=organization_id, user_id=user_id).first()
    ...
    def create_invitation(self, organization_id: int, email: str, role: str, token_hash: str, expires_at) -> OrganizationInvitation:
    ...
    def get_invitation_by_token(self, token_hash: str) -> Optional[OrganizationInvitation]:
