...
class TeamRepository:
    ...
    def create_team(self, organization_id: int, name: str, slug: str, parent_id: Optional[int] = None) -> Team:
    ...
    def create_invitation(self, team_id: int, email: str, role: str, token_hash: str, expires_at) -> TeamInvitation:
        inv = TeamInvitation(
            team_id=team_id,
            email=email,
            role=role,
    ...
    def get_invitation_by_token(self, token_hash: str) -> Optional[TeamInvitation]:
