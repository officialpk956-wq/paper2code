...
class VerificationService:
    ...
    def verify_email(self, token: str, ip_address: Optional[str], user_agent: Optional[str]) -> bool:
    ...
    def resend_verification(self, email: str, ip_address: Optional[str], user_agent: Optional[str]) -> None:
